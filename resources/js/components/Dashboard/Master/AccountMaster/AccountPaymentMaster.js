...
function AccountPaymentMaster() {
    ...
    rows = accountPayments.map((item, index)=>{
        return createData(
            item.id, 
    ...
    const jQueryCode = () => {
        $('.btnDeleteAccountCourse').each((index, item) => {
            $(item).click((event)=>{
                ...
                axios
                    .post('/api/deleteAccountPayment', {id: deleteAccountId})
                    .then((res)=>{
    ...
    const handleSubmit = async (event) => {
        ...
        await window.axios
            .post('/api/registAccountPayment', accountInfo)
            .then((response) => {
    ...
    const onEditAccount = async (event) => {
        ...
        await window.axios
            .post('/api/editAccountPayment', accountInfo)
            .then((response) => {
...
export default AccountPaymentMaster
