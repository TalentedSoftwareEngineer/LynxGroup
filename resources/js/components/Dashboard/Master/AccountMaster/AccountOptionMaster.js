...
function AccountOptionMaster() {
    ...
    rows = accountOptions.map((item, index)=>{
        return createData(
            item.id, 
    ...
    const jQueryCode = () => {
        $('.btnDeleteAccountCourse').each((index, item) => {
            $(item).click((event)=>{
                ...
                axios
                    .post('/api/deleteAccountOption', {id: deleteAccountId})
                    .then((res)=>{
    ...
    const handleSubmit = async (event) => {
        ...
        await window.axios
            .post('/api/registAccountOption', accountInfo)
            .then((response) => {
    ...
    const onEditAccount = async (event) => {
        ...
        await window.axios
            .post('/api/editAccountOption', accountInfo)
            .then((response) => {
...
export default AccountOptionMaster
